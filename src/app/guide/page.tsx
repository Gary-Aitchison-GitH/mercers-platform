...
const sections = [
  {
    ...
    steps: [
      ...
      'Choose which AI fixes to apply: auto-enhance, crop to 5×7 landscape, remove people & pets, close open toilet lids.',
      'Hit <strong>Process</strong> — the AI works on all photos at once.',
      'Drag the slider on any result to compare before vs after.',
