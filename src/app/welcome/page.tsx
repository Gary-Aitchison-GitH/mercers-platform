...
export default function WelcomePage() {
  const [stage, setStage] = useState<'intro' | 'features' | 'compare' | 'ready'>('intro')
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-12 relative overflow-hidden"
      ...
      <div className="absolute inset-0 pointer-events-none" style={{
        backgroundImage: 'radial-gradient(ellipse at 80% 20%, rgba(201,165,76,0.12) 0%, transparent 60%), radial-gradient(ellipse at 20% 80%, rgba(201,165,76,0.08) 0%, transparent 50%)',
      }} />
      ...
      <AnimatePresence mode="wait">
        ...
        {stage === 'intro' && (
          ...
          >
            ...
            >
              <div className="w-14 h-14 rounded-2xl flex items-center justify-center" style={{ background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(201,165,76,0.4)' }}>
          ...
          >
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <div className="flex items-start gap-5 mb-6">
                  <div className="w-14 h-14 rounded-2xl flex items-center justify-center shrink-0" style={{ background: currentFeature.color }}>
                ...
                <div className="flex items-start gap-3 rounded-xl p-4" style={{ background: 'rgba(201,165,76,0.1)', border: '1px solid rgba(201,165,76,0.25)' }}>
            ...
            <div className="flex items-center justify-between mt-6">
              <button
                ...
                className={`text-sm font-medium px-4 py-2 rounded-xl transition-colors ${featIndex === 0 ? 'opacity-30 pointer-events-none' : 'text-white hover:bg-white/10'}`}
              >
                ← Back
              </button>
        ...
        {stage === 'compare' && (
          ...
          >
            <div className="text-center mb-8">
              <p className="text-xs font-semibold tracking-widest uppercase mb-2" style={{ color: '#C9A54C' }}>The difference</p>
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              ...
              <div className="text-center">
                <p className="text-xs font-bold tracking-wider uppercase mb-3" style={{ color: '#C9A54C' }}>Mercers Platform</p>
              </div>
            </div>
            ...
            <div className="space-y-3 mb-8">
              {vsItems.map((item, i) => (
                ...
                >
                  <div className="rounded-xl px-4 py-3 text-sm text-gray-400 leading-snug" style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)' }}>
                    {item.old}
                  </div>
                  <div className="rounded-xl px-4 py-3 text-sm text-white leading-snug flex items-start gap-2" style={{ background: 'rgba(201,165,76,0.12)', border: '1px solid rgba(201,165,76,0.3)' }}>
            ...
            <div className="text-center">
              <button
                ...
                style={{ background: 'linear-gradient(135deg, #1B3A6B 0%, #2a5aa8 100%)', border: '1px solid rgba(201,165,76,0.4)' }}
              >
